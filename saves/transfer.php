...
$secret_key = "sk_live_fb38c68835c2cbe2d61888507224b31bba491b0b"; //get_option('jettrade_paystack_secret');
...
if(preg_match("/succ/",$status) || preg_match("/pend/",$status) || preg_match("/proc/",$status)):
    $return = "success";
